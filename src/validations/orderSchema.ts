...
export const orderSchema = z.object({
  ...
  status: z.enum([OrderStatus.INIT, OrderStatus.PENDING, OrderStatus.SHIPPED, OrderStatus.DELIVERED, OrderStatus.CANCELLED, OrderStatus.COMPLETED]).default(OrderStatus.INIT),
